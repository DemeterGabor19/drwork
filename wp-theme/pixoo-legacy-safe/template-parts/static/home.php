<main>
      ...
      <section class="section page-hero home-hero">
        <div class="container page-hero-grid">
          <div class="page-hero-copy">
            ...
            <div class="social-proof">
              <div class="avatars" aria-label="Elégedett ügyfelek">
                <span>AK</span><span>BM</span><span>GT</span><span>PK</span>
              </div>
              <div>
                <p class="stars">*****</p>
          ...
          <div class="brand-hero-visual" aria-label="Dr.Work munkaruha látványterv">
            <img
      ...
      <section class="section home-features">
        <div class="container feature-strip reveal">
          <article>
            <img
              class="feature-icon"
              src="/assets/images/icons/ikon-1.png"
              decoding="async"
              alt=""
              aria-hidden="true"
            />
          ...
          <article>
            <img
              class="feature-icon"
              src="/assets/images/icons/ikon-2.png"
              decoding="async"
              alt=""
              aria-hidden="true"
            />
          ...
          <article>
            <img
              class="feature-icon"
              src="/assets/images/icons/ikon-3.png"
              decoding="async"
              alt=""
              aria-hidden="true"
            />
          ...
          <article>
            <img
              class="feature-icon"
              src="/assets/images/icons/ikon-4..png"
              decoding="async"
              alt=""
              aria-hidden="true"
            />
        ...
        <div class="container">
          ...
          <div class="timeline">
            <article class="step reveal">
              <img
                class="step-icon"
                src="/assets/images/icons/ikon-5.png"
                alt=""
                aria-hidden="true"
              />
            ...
            <article class="step reveal">
              <img
                class="step-icon"
                src="/assets/images/icons/ikon-6.png"
                alt=""
                aria-hidden="true"
              />
            ...
            <article class="step reveal">
              <img
                class="step-icon"
                src="/assets/images/icons/ikon-7.png"
                alt=""
                aria-hidden="true"
              />
      ...
      <!-- @include: ./template-parts/sections/showcase.html -->
      <section class="section dark-showcase" id="termekek">
        <div class="container dark-grid">
          ...
          <div
            class="mockup-builder reveal"
            data-mockup-builder
            aria-label="Munkaruha látványterv"
          >
            <aside class="mockup-panel">
              ...
              <div class="mockup-control">
                ...
                <div class="color-swatches" aria-label="Színválasztó">
                  ...
                  ></button>
                  <button
                    class="swatch swatch-gray is-active"
                    type="button"
                    data-color="gray"
                    aria-label="Szürke"
                  ></button>
            ...
            <div class="mockup-thumbs" aria-label="Termékválasztó">
              <button
      ...
      <!-- @include: ./template-parts/sections/brands.html -->
      <section class="section brands" id="markak">
        <div class="container brands-grid">
          ...
          <div class="brand-showcase reveal" data-brand-carousel>
            <div class="brand-cards">
              <article class="brand-card brand-malfini" data-brand-card>
              ...
              <article class="brand-card brand-snickers" data-brand-card>
                <div class="brand-logo-box brand-logo-box-dark">
            ...
            <button
              class="brand-nav brand-prev"
              type="button"
              data-brand-prev
              aria-label="Előző márkák"
            >
              ‹
            </button>
            <button
              class="brand-nav brand-next"
              type="button"
              data-brand-next
              aria-label="További márkák"
            >
              ›
            </button>

            <div class="brand-dots" data-brand-dots aria-label="Márka oldalak">
              <button class="is-active" type="button" aria-label="1. oldal"></button>
            </div>
          </div>
        </div>
      </section>
          ...
          <article class="decision-card decision-card-dark reveal">
            <div class="decision-inner">
              ...
              <div class="decision-cta">
                <a class="btn btn-outline-light" href="/kapcsolat.html#ajanlatkeres" data-i18n="home.noShop.cta">
                  Tudj meg többet
                </a>
              </div>
            </div>
        ...
        <div class="support-grid">
          ...
          <article class="support-card support-card-delivery reveal">
            <div class="support-inner">
              ...
              <div class="support-visual delivery-visual" aria-hidden="true">
                <img
                  src="/assets/images/icons/GLS.png"
                  alt=""
                  loading="lazy"
                  decoding="async"
                />
      ...
      <!-- @include: ./template-parts/sections/cta.html -->
      <section class="section cta-band" id="kapcsolat">
